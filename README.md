...
Identify key drivers impacting profitability
...
Conducted initial exploration

2. Exploratory Data Analysis (Python)
Analyzed sales and profit distribution
Studied discount impact on profitability
Identified category and regional trends

3. SQL Analysis
Aggregated sales and profit metrics
Performed category-wise and region-wise analysis
...
Overall profit margin is approximately 12.5%, indicating moderate profitability
...
📷 Dashboard Preview : 
<p align="center"> <img src="Sales & Profit -1.png" width="900"> </p>
